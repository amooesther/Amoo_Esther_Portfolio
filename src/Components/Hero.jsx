...
const Hero = () => {
  ...
  return (
    <div className="border-b border-neutral-400 pb-4 lg:mb-36">
        <div className="flex flex-wrap">
            ...
            <div className="flex flex-col items-center lg:items-start">
                ...
                initial='hidden'
                animate='visible'              
                className="pb-16 text-5xl font-thin tracking-tight lg:mt-16 lg:text-7xl">Amoo Esther O.</motion.h1>
            <motion.span 
            ...
            initial='hidden'
            animate='visible' 
            className='my-2 max-w-xl py-6 font-light tracking-tight text-sm'>{HERO_CONTENT}</motion.p>
            </div>
            </div>
