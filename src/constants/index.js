...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    company: "Empower Her Community",
    description: `Collaborated with the design team to develop wireframes, prototypes, and visual designs, conducting user research to identify user needs and preferences. Participated in design critiques and provided constructive feedback, creating and presenting design concepts to stakeholders. Additionally, assisted with the design of marketing materials and social media content.`,
